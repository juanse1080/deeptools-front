...
export default function List(props) {
  ...
  useEffect(() => {
    axios
      .get(
        `${host}/accounts/profile/${
          props.match.params.id ? props.match.params.id : user.id
        }`,
        authHeaderJSON()
      )
      .then(function(res) {
                    ...
                    {module.photo ? (
                      <Card className="rounded-pill" variant="outlined">
                        <CardMedia
                          ...
                          image={`${host}${module.photo}`}
                          title={module.first_name}
                        />
                      </Card>
                    ) : (
                      <Card className="rounded-pill" variant="outlined">
                        <CardMedia
                          className={classes.mediaProfile}
                          image={`${host}/media/users/default.png`}
                          title={module.first_name}
                        />
                      </Card>
                    )}
                  ...
                  <Grid item xs={8} sm={12}>
                    ...
                    <Typography
                      ...
                      {module.role === 'developer'
                        ? module.owner !== 1
                          ? `${module.owner} algorithms`
                          : 'One algorithm'
                        : module.subscriptions !== 1
