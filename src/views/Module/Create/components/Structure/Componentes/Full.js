      ...
      <Grid container spacing={2}>
          ...
          <Grid container spacing={2}>
            ...
            </Grid>
            {
              md ? <Grid item lg={5} md={6} sm={12} xs={12}>
                <Highcharts oneToOne={true} change={change('graph')} element={elements.graph} />
              </Grid> : null
            }
        ...
        </Grid>
        {
          lg ? <Grid item lg={5} md={6}>
            <Highcharts oneToOne={true} change={change('graph')} element={elements.graph} updateView={updateView} />
          </Grid>
            : null
        }
      </Grid>
